...
HRESULT DXBuffer::apply(UINT32 p_misc)
{
	HRESULT hr = S_OK;
...
HRESULT DXBuffer::init(ID3D11Device* p_pDevice, ID3D11DeviceContext* p_pDeviceContext, BufferInitDesc& p_refInitDesc)
{
	m_pDevice = p_pDevice;
...
ID3D11Buffer* DXBuffer::getBufferPointer()
{
	return m_pBuffer;
}

UINT32 DXBuffer::getVertexSize()
{
	return m_elementSize;
}

UINT32 DXBuffer::getElementCount()
{
